...
const Dashboard = () => {
  ...
  const { companyData, setCompanyToken , setCompanyData} : any = useContext(AppContext);
              ...
              <div className="relative group">
                ...
                <div className="absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-12 ">
                  <ul className="list-none m-0 p-2 bg-white rounded-md border border-gray-300 text-sm">
                    <li onClick={logout} className="py-1 px-2 rounded cursor-pointer">Logout</li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <div className="flex">
        ...
        <div className="inline-block min-h-screen border-r-2 border-r-gray-300">
          <ul className="flex flex-col items-start pt-5 text-gray-800">
            <NavLink
              className={({ isActive }) =>
                `flex items-center p-3 sm:px-6 gap-2 w-full hover:bg-gray-100 ${
                  isActive && "bg-blue-100 border-r-4 border-r-blue-500"
                }`
              }
            ...
            >
              <img className="min-w-4" src={assets.persontick_icon} alt="" />
